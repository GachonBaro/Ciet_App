...
public class Fragment_SetiQ_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // init View
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_setiq_4, container, false);

        // get SETI survey recyclerView
        setiSurveyRecyclerView = viewGroup.findViewById(R.id.seti_survey_page_4_recyclerView);

        // init adapter
        setiSurveyAdapter = new SetiSurveyAdapter(4);
