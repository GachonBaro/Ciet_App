...
public class Fragment_SetiQ_0 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // init ViewGroup
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_setiq_0, container, false);

        // get SETI survey recyclerView
        setiSurveyRecyclerView = viewGroup.findViewById(R.id.seti_survey_page_0_recyclerView);

        // init adapter
        setiSurveyAdapter = new SetiSurveyAdapter(0);
