...
public class Fragment_SetiQ_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // init ViewGroup
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_setiq_3, container, false);

        // get SETI survey recyclerView
        setiSurveyRecyclerView = viewGroup.findViewById(R.id.seti_survey_page_3_recyclerView);

        // init adapter
        setiSurveyAdapter = new SetiSurveyAdapter(3);
