...
public class Fragment_initQ_4 extends Fragment {
    private TextView question;
    private RadioGroup radioGroup;
    public static boolean isAnswered=false;

    public Fragment_initQ_4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // 뷰 초기화 및 연결
        ViewGroup viewGroup=(ViewGroup)inflater.inflate(R.layout.fragment_initq_4, container, false);
        question=viewGroup.findViewById(R.id.init_question4);
        radioGroup=viewGroup.findViewById(R.id.q5_radiogroup);

        // 문제 표시
        question.setText(InitQnA.Q4);
