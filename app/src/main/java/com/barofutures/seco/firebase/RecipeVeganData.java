...
public class RecipeVeganData {

    public String ATT_FILE_NO_MAIN;
    public String ATT_FILE_NO_MK;
    public Double INFO_CAR;
    public Double INFO_ENG;
    public Double INFO_FAT;
    public Double INFO_NA;
    public Double INFO_PRO;
    ...
    public String SEA_FOOD;
    public String RCP_PARTS_DTLS;

    public RecipeVeganData() {

    }

    public RecipeVeganData(String ATT_FILE_NO_MAIN, String ATT_FILE_NO_MK, Double INFO_CAR, Double INFO_ENG, Double INFO_FAT, Double INFO_NA, Double INFO_PRO, String MANUAL01, String MANUAL02, String MANUAL03, String MANUAL04, String MANUAL05, String MANUAL06, String MANUAL07, String MANUAL08, String MANUAL09, String MANUAL10, String MANUAL11, String MANUAL12, String MANUAL13, String MANUAL14, String MANUAL15, String MANUAL16, String MANUAL17, String MANUAL18, String RCP_PAT2, String RCP_WAY2, String SEA_FOOD, String RCP_PARTS_DTLS) {
