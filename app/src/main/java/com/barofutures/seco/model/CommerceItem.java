...
public class CommerceItem {
    ...
    public static String commerceDiningTabItemList[][]={
            // image url, name
            {"https://mblogthumb-phinf.pstatic.net/20160426_55/ppanppane_14616500115941uytb_PNG/%C6%C4%B8%AE%B9%D9%B0%D4%C6%AE_%B7%CE%B0%ED_%282%29.png?type=w800", "파리바게트"},
            {"https://t1.daumcdn.net/cfile/tistory/99857F4F5E738F472F", "스타벅스"},
            {"https://blog.kakaocdn.net/dn/bpuITQ/btqGHM1V4gC/KlsRpwegpSxnYj9oJNKx0K/img.png", "CU 편의점"},
            {"https://t1.daumcdn.net/cfile/tistory/9933B5405B515D3613", "쉐이크 쉑"}
    };
}
